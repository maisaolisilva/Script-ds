  ...
  try {
    ...
    const clienteEmail = await resend.emails.send({
      ...
      html: `
        ...
        <p>Obrigado por entrar em contato! Recebemos a sua solicitação de orçamento e, em breve, entrarei em contato para entender melhor as suas necessidades e apresentar a melhor solução para o seu site.</p>
        ...
        <ul style="list-style-type: disc; padding-left: 20px;">
          <li>Qual é o principal objetivo do seu site? (Ex.: vender produtos, divulgar serviços, captar contatos, blog, etc.)</li>
          <li>Tem alguma referência de site que gosta e gostaria de seguir como inspiração?</li>
          <li>Quais páginas e seções considera essenciais? (Ex.: Página inicial, Sobre, Serviços, Portifólio, Contactos, etc.)</li>
          <li>Já tem identidade visual (logotipo, cores, tipografia) ou precisa de ajuda com isso?</li>
          <li>Precisa de funcionalidades específicas? (Ex.: formulário de contato, integração com redes sociais, loja online, área de membros, etc.)</li>
        </ul>
        <p>Com estas informações, poderei desenvolver uma proposta mais alinhada com as suas expectativas.</p>
        <p>Caso tenha alguma dúvida, pode entrar em contato comigo a qualquer momento pelo e-mail scriptdesenvolvimento@gmail.com ou pelo WhatsApp +55 24 99258-1089.</p>
